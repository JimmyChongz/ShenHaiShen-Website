                      ...
                      <CardFooter>
                        <Box
                          ...
                          onClick={() => {
                            ...
                            setShopCarPriceTotal(
                              shopCarPriceTotal + orderGun.price
                            );
                            setShopCarItems([
                              ...shopCarItems,
                              { food: orderGun.food, price: orderGun.price },
                            ]);
                          }}
                        >
                          加入購物車
                      ...
                      <CardFooter>
                        <Box
                          ...
                          onClick={() => {
                            ...
                            setOrderCount(orderCount + 1);
                            setShopCarPriceTotal(
                              shopCarPriceTotal + orderConvenient.price
                            );
                            setShopCarItems([
                              ...shopCarItems,
                              {
                                food: orderConvenient.food,
                                price: orderConvenient.price,
                              },
                            ]);
                          }}
                        >
                      ...
                      <CardFooter>
                        <Box
                          ...
                          onClick={() => {
                            ...
                            setOrderCount(orderCount + 1);
                            setShopCarPriceTotal(
                              shopCarPriceTotal + orderDish.price
                            );
                            setShopCarItems([
                              ...shopCarItems,
                              {
                      ...
                      <CardFooter>
                        <Box
                          ...
                          onClick={() => {
                            ...
                            setOrderCount(orderCount + 1);
                            setShopCarPriceTotal(
                              shopCarPriceTotal + orderOther.price
                            );
                            setShopCarItems([
                              ...shopCarItems,
                              {
                                food: orderOther.food,
                                price: orderOther.price,
                              },
                            ]);
                          }}
                        >
